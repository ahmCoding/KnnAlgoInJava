...
/**
 * implementiert die einen Datenpunknt in oneHotencoded Version von
 * Dataset <a href="http://archive.ics.uci.edu/ml/datasets/Bank+Marketing">...</a>
 *
 * @author Tradingcat
 */

public class BankMarketingDataPoint extends DataPoint {
    ...
    public double[] getAttributes() {
        ...
        ret[64] = euribor3m;
        ret[65] = nrEmployed;
        // Hier wird bewusst die Ausgabe von Label wegen dataLeak in Test-sets vermieden
        return ret;
    }
